...
void MainWindow::settings()
{
    ...
    QStringList str;
    str << "Имя файла" << "Расширение" << "Размер изображения" << "Горизонтальное разрешение" << "Вертикальное разрешение" << "Глубина цвета" <<"Сжатие";
    ...
    box->addWidget(this->pbArch,0,2);
    box->addWidget(this->pbDir,0,1);
    box->addWidget(this->leDir,0,0);
...
{
    QString fileName = QFileDialog ::getOpenFileName(this, tr("open an archive."),"/home/overlord/",tr("zip(*zip)"));
